...
/**
 * create_node - Creates the new levelorder_queue_t node.
...
/**
 * push - Push the node to the back of a levelorder_queue_t queue.
 * @node: binary tree node to print and push.
 * @head: double pointer to the head of the queue.
 * @tail: double pointer to the tail of the queue.
 * Description: Upon failure, exit with a code of 1.
 */
...
/**
 * pop - will Pop the head of a levelorder_queue_t queue.
 * @head: double pointer to the head of the queue.
 */
