...
/**
  * binary_tree_height - func returns the height of a binary tree
...
/**
  * binary_tree_balance - func checks to see if the binary tree is
  * balanced
  * @tree: tree to measure
...
/**
  * binary_tree_is_perfect - func that checks if tree is perfect
  * @tree: tree to check
