...
/**
 * binary_tree_is_heap - checks if binary tree is a valid Max Binary Heap
...
/**
 * btih_helper - checks if binary tree is a valid Max Binary Heap
...
int binary_tree_is_complete(const binary_tree_t *tree)
{
	...
	return (btih_helper(tree, 0, size));
}
/**
